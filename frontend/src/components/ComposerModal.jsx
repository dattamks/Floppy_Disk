    ...
    <React.Fragment>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '9px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          <span style={{ fontSize: '11px', color: theme.textFaint }}>Posting as admin</span>
        </div>
      </div>{' '}
      <textarea
          ...
          >
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none">
              <rect
                ...
                strokeWidth="1.6"
              />
              <path d="M3 16l5-4 4 3 3-2 6 5" stroke={theme.brand} strokeWidth="1.6" />
            </svg>
        ...
        >
          <svg width="15" height="15" viewBox="0 0 24 24" fill="none">
            <rect
              ...
              strokeWidth="1.6"
            />
            <circle cx="8.5" cy="9" r="1.5" stroke={theme.textMuted} strokeWidth="1.6" />
            <path d="M3 16l5-4 4 3 3-2 6 5" stroke={theme.textMuted} strokeWidth="1.6" />
          </svg>
          Photo
        </button>{' '}
        <button
